...
// Interface Class: Handle User Tasks
...
class Interface {
   ...
   static addBookToList(book) {
      ...
      row.innerHTML = `
         ...
         <td>${book.author}</td>
         <td>${book.isbn}</td>
         <td class="d-flex justify-content-end"><a href="#" class="btn btn-outline-dark btn-sm delete">Remove</a></td>
      `;
